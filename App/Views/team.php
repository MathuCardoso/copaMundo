        ...
        <div class="card-container">
            <div id="players" class="listar-figurinhas row">
                ...
                <?php foreach ($data['players'] as $player) : ?>
                    <?php
                    // Supondo que $player contenha informações sobre o jogador, você pode acessar informações sobre o time aqui
                    $team = $player['selecao']; // Supondo que a seleção do jogador seja armazenada em $player['selecao']
                    ?>
